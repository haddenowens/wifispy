...
public class HomeActivity extends ListActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		mAccessPoints = new AccessPointListAdapter(
			HomeActivity.this,
			R.layout.home_row,
			mCursor,
			from,
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		if(SERVICE_STATUS == 1) {
			menu.add(0, TOGGLE_SERVICE, 0, "Stop Scanning").setIcon(android.R.drawable.ic_menu_search);
		} else {
			menu.add(0, TOGGLE_SERVICE, 0, "Start Scanning").setIcon(android.R.drawable.ic_menu_search);
		}
