...
public class HomeActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAccessPoints = new AccessPointListAdapter(HomeActivity.this, R.layout.home_row, mCursor, from, to);
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            ...
            case DIALOG_GPS_DISABLED:
                builder.setCancelable(false).setTitle("GPS signal not Found").setMessage(
                    "GPS is not enabled, and accuracy may be effected.").setNeutralButton("Ok",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            startService();
                            dialog.dismiss();
